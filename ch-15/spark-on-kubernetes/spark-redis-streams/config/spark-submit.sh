...
$SPARK_HOME/bin/spark-submit \
    ...
    --conf "spark.driver.extraJavaOptions=-Dconfig.file=local:///opt/spark/app/conf/df-grouped-aggs.conf" \
    --conf "spark.executor.extraJavaOptions=-Dconfig.file=local:///opt/spark/app/conf/df-grouped-aggs.conf" \
